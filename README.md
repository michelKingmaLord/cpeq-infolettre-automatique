...
Génération automatique d'infolettres<

## Using

_Python package_: to add and install this package as a dependency of your project, run `poetry add cpeq-infolettre-automatique`.
